---
name: ski-toolkit-pipeline-debug
description: Use when debugging issues that span upload, status polling, result retrieval, video processing, pose estimation, coaching generation, rendering, or frontend analysis flow in the ski-analyzer repository through the installed Ski Analyzer Toolkit plugin.
---
