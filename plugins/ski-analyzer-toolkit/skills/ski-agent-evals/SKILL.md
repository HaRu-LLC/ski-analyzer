---
name: ski-toolkit-agent-evals
description: Use when adding or updating evaluation, trace grading, fallback checks, unsupported-claim detection, or regression fixtures for app-side agent behavior in the ski-analyzer repository through the installed Ski Analyzer Toolkit plugin.
---
