---
name: ski-toolkit-backend-change
description: Use when changing backend FastAPI, Python services, schemas, routes, config, or tests in the ski-analyzer repository through the installed Ski Analyzer Toolkit plugin. Do not use for frontend-only work.
---
