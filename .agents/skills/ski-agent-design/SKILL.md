---
name: ski-agent-design
description: Use when designing or updating app-side agent boundaries, provider selection, structured outputs, review flows, guardrails, or durable agent docs in the ski-analyzer repository.
---
